...
What the Query Does
CTE 1 - monthly_transactions: Groups savings transactions by user and month, counting how many transactions each user made per month.

CTE 2 - avg_transactions_per_user: Calculates each user’s average number of transactions per month based on the monthly counts.
...
CLV =(Transactions Tenure in months) x12 × Avg Profit per Transaction
